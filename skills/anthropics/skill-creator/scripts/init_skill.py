...
def init_skill(skill_name, path):
    ...
    try:
        ...
        print(f"โ… Created skill directory: {skill_dir}")
    ...
    try:
        ...
        print("โ… Created scripts/example.py")
        ...
        print("โ… Created references/api_reference.md")
        ...
        print("โ… Created assets/example_asset.txt")
    except Exception as e:
        print(f"โ Error creating resource directories: {e}")
        return None

    # Print next steps
    print(f"\nโ… Skill '{skill_name}' initialized successfully at {skill_dir}")
    print("\nNext steps:")
